...
현재 단계: **v0.6.8에서 외부 모델 칸 식별 충돌과 진단 정합성·Popup 실패 수명주기를 보완하고 실제 사용자 환경 검증 대기 중**
...
| 자동 검사 | ✅ 완료 | 단위·통합·수명주기·보안 경계·버전 일치 검사 160개 통과 |
...
실제 검증에서 발견되는 v0.6 범위의 후속 결함은 `v0.6.9`, `v0.6.10`, ... 패치 버전으로 수정합니다.
...
| v0.6.8 | ✅ 현재 릴리스·🧪 사용자 검증 대기 | 외부 target 식별 안정화, 진단 정합성, Popup 실패 정리와 CI Action 갱신 |
