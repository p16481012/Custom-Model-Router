...
현재 버전은 **v0.6.2**이며, SillyTavern 1.18.0의 등록 가능한 Chat Completion 연결 24개, 공개 Registry API, Connection Profile 기반 보조 요청 라우팅, 범용 DOM 모델 브리지, 호환성 진단과 비밀정보를 제외한 설정 백업·복구를 제공합니다. v0.6.2는 사용자 피드백에 따라 v0.6.1의 관리 팝업 UI 변경을 되돌리고, 다음 UI 방향을 다시 논의하기 위한 롤백 릴리스입니다.
...
| `v0.6.2` | v0.6.1 UI 변경 롤백·제품 방향 재논의 | ✅ 현재 릴리스 |
